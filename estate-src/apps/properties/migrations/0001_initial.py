# Generated by Django 3.2.7 on 2024-08-31 09:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Ranchi', max_length=255, verbose_name='City')),
                ('postal_code', models.CharField(default='825311', max_length=255, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Block More Barkagaon', max_length=255, verbose_name='Street Address')),
                ('property_number', models.IntegerField(default='101', validators=[django.core.validators.MinValueValidator(1)], verbose_name='Property Number')),
                ...
                ('advert_type', models.CharField(choices=[('For Sale', 'House'), ('For Rent', 'Apartment'), ('For Auction', 'Auction')], default='For Sale', max_length=50, verbose_name='Advert type')),
