...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"),max_length=255,default="Ranchi")
    postal_code = models.CharField(verbose_name=_("Postal Code"),max_length=255,default="825311")
    street_address = models.CharField(verbose_name=_("Street Address"),max_length=255,default="Block More Barkagaon")
    property_number = models.IntegerField(verbose_name=_("Property Number"),validators=[MinValueValidator(1)],default="101")
