...
class Profile(TimeStampedUUIDModel):
    ...
    license = models.CharField(verbose_name=_("Real Estate License"), max_length=200, blank=True,null=True)
    ...
    city = models.CharField(verbose_name=_("City"),max_length=200,default="Ranchi", blank=False,null=False)
    ...
    ratings = models.DecimalField(verbose_name=_("ratings"),max_digits=4,decimal_places=2, null=True,blank=True)
    num_reviews = models.IntegerField(verbose_name=_("Number reviews"),default=0, null=True,blank=True)
